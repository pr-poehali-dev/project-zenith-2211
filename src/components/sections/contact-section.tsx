          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-4 md:space-y-8">
              ...
              >
                ...
                <p className="text-base text-foreground md:text-2xl">Remote · Worldwide</p>
              </div>
          ...
          <div className="flex flex-col justify-center">
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              >
                ...
                {submitSuccess && (
                  <p className="mt-3 text-center font-mono text-sm text-foreground/80">Message sent! We'll be in touch soon.</p>
                )}
              </div>
            </form>
          </div>
